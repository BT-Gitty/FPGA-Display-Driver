...
This means I will have to convert my memory address readings into an AXI-stream (custom module probably), then feed it into DMA S2MM to quickly communicate with the DDR3. I think the data also returns the same way.
